        ...
        <div class="modal-body">
            <form id="formEdit" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tujuan_surat" id="edit_tujuan_surat" placeholder="Input Here..">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" name="file_surat_keluar" id="edit_file_surat_keluar" placeholder="Input Here..">
...
$(document).on('click', '.edit-modal', function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#preview').attr('src', `{{ asset('uploads/suratKeluar/${response.data.file_surat_keluar}')}}`)
